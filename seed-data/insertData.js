...
const seedData = {
  courses: [
                ...
                },
                {
                  ...
                  "reviews": [
                    {
                      "id": "57029ed4795118be119cc43c"
                    }
                  ],
                  "steps": [
                    {
                      "id": "57029ed4795118be119cc442",
                      "stepNumber": 1,
                      "title": "Blah Blah Blah",
...
const initUsers = function(){
    user.find({}, function(err, result){
      ...
      if (result.length == 0 ){
          // inserting data
            user.insertMany(seedData.users, function(err){
              console.error(err);
            });
      } else {
